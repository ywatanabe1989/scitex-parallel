...
# (project=scitex-parallel, owner=ywatanabe1989, repo=scitex-parallel,
...
TMPDIR="/tmp/publish-scitex_parallel-${GITHUB_RUN_ID:-0}-${GITHUB_RUN_ATTEMPT:-0}-$V"
export TMPDIR
rm -rf "$TMPDIR"
...
echo "PUBLISH-OK: scitex-parallel dist/* uploaded to PyPI via manual OIDC trusted publishing"
